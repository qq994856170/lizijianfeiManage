...
public class PostImage {
	...
	public static void main(String []args) throws ClientProtocolException, IOException{
		String token = Token.createToken(new Date().getTime()+3600, 29445 );
		String result = PostImage.doUpload(new File("C:/Users/123/Desktop/992145_131521903785_2_02.jpg"), token);
